...
export interface ILifecycleMainService {
	 ...
	 */
	readonly onBeforeCloseWindow: Event<IAppWindow>;

	/**
	 * Make a `ICodeWindow` known to the lifecycle main service.
	 */
	registerWindow(window: IAppWindow): void;

	/**
	 * Reload a window. All lifecycle event handlers are triggered.
	 */
	reload(window: IAppWindow, cli?: NativeParsedArgs): Promise<void>;

	/**
	 * Unload a window for the provided reason. All lifecycle event handlers are triggered.
	 */
	unload(window: IAppWindow, reason: UnloadReason): Promise<boolean /* veto */>;
...
export class LifecycleMainService extends Disposable implements ILifecycleMainService {
	...
	private readonly _onBeforeCloseWindow = this._register(new Emitter<IAppWindow>());
	...
	async reload(window: IAppWindow, cli?: NativeParsedArgs): Promise<void> {
	...
	private async doUnload(window: IAppWindow, reason: UnloadReason): Promise<boolean /* veto */> {
