...
export function registerColorThemeExtensionPoint() {
	return ExtensionsRegistry.registerExtensionPoint<IThemeExtensionPoint[]>({
		...
		jsonSchema: {
			...
			items: {
				type: 'object',
				defaultSnippets: [{ body: { label: '${1:label}', id: '${2:id}', uiTheme: MOTE_DARK_THEME, path: './themes/${3:id}.tmTheme.' } }],
				properties: {
					id: {
					...
					uiTheme: {
						...
						enum: [MOTE_LIGHT_THEME, MOTE_DARK_THEME, MOTE_HC_DARK_THEME, MOTE_HC_LIGHT_THEME]
					},
					path: {
