...
(function (globalThis, factory) {
	...
	async function load(modulePaths, resultCallback, options) {
		...
		if (!safeProcess.sandboxed) {
			loaderConfig.amdModulesPattern = /(^vs\/)|(^mote\/)|(^vscode-textmate$)|(^vscode-oniguruma$)|(^xterm$)|(^xterm-addon-search$)|(^xterm-addon-unicode11$)|(^xterm-addon-webgl$)|(^@vscode\/iconv-lite-umd$)|(^jschardet$)|(^@vscode\/vscode-languagedetection$)|(^vscode-regexp-languagedetection$)|(^tas-client-umd$)/;
		}
